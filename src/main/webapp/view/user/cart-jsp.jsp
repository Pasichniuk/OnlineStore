...
<div class="container">
    ...
    <c:if test="${currentPage != 1}">
        <td><a href="${pageContext.request.contextPath}/cart?page=${currentPage - 1}">Previous</a></td>
    </c:if>
    ...
    <c:if test="${currentPage lt pagesAmount}">
        <td><a href="${pageContext.request.contextPath}/cart?page=${currentPage + 1}">Next</a></td>
    </c:if>
